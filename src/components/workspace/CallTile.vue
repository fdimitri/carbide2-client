...
<template>
  <div class="relative shrink-0 w-36 h-28 rounded-ui-md overflow-hidden bg-black border monaco-panel-border">
    <video
      ref="videoEl"
      autoplay
      playsinline
    ...
    <span class="absolute bottom-0 left-0 right-0 px-1 py-px text-ui-2xs text-white bg-black/55 truncate">
      {{ label }}
    </span>
  </div>
</template>
